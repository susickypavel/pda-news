...
export type InterestPickScreenRouteProp = RouteProp<RootStackParamList, "InterestPick">;

export type InterestPickScreenNavigationProp = NavigationProp<RootStackParamList, "InterestPick">;

type InterestScreenProps = {
	route: InterestPickScreenRouteProp;
	navigation: InterestPickScreenNavigationProp;
};
...
export const InterestPickScreen: React.FC<InterestScreenProps> = () => {
